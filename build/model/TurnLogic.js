...
var TurnLogic = (function () {
    ...
    Object.defineProperty(TurnLogic.prototype, "betState", {
        get: function () {
    ...
    TurnLogic.prototype._startGame = function () {
        ...
        if (this._flag[1] && this._clock.get.seconds() > 1.5) {
            this._flag[1] = false;
            for (var _i = 0, _a = this._table.players; _i < _a.length; _i++) {
                var player = _a[_i];
                player.score -= 10;
    ...
    TurnLogic.prototype._finalRound = function () {
        ...
        if ((this._opponent[0].gameOver && this._opponent[1].gameOver) ||
